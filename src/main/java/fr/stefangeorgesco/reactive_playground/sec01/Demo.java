package fr.stefangeorgesco.reactive_playground.sec01;
...
/*
   ...
   3. subscriber can cancel the subscription. producer should stop at that moment the subscriber is no longer
   interested in consuming the data.
   4. producer can send the error signal.
 */

import fr.stefangeorgesco.reactive_playground.sec01.publisher.PublisherImpl;
